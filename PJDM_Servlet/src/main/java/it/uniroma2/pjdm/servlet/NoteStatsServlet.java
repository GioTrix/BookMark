...
/**
 * Servlet implementation class NoteStatsServlet
 */
public class NoteStatsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			int noteStats = dao.getNoteStats(idUtente);
			...
			if (noteStats == 0) {
				...
				JSONObject noteStatsJson = new JSONObject();
				noteStatsJson.put("noteStats", noteStats);
				out.print(noteStatsJson.toString());
				out.flush();
			}
